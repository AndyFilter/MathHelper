...
const int windowX = 1200+16, windowY = 620+39;
...
HWND GUI::Setup(int (*OnGuiFunc)())
{
	...
	wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, _T("Math Thing"), NULL };
	//wc.hIcon = LoadIcon(wc.hInstance, MAKEINTRESOURCE(IDI_ICON1));
	//wc.hIconSm = LoadIcon(wc.hInstance, MAKEINTRESOURCE(IDI_ICON1));
	::RegisterClassEx(&wc);

	hwnd = ::CreateWindowW(wc.lpszClassName, _T("Something With Math"), (WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX | WS_SIZEBOX), 200, 100, windowX, windowY, NULL, NULL, wc.hInstance, NULL);
